...
public class Messages {
	...
	public static final String SEED_NOT_A_NUMBER_ERROR = String.format("%s ", SEED_NOT_A_NUMBER);
	...
	public static final String ZOMBIE_COMUN_SYMBOL = "Z";

	public static final String ZOMBIE_COMUN_NAME = "Zombie";
	
	public static final String BUCKETHEAD_SYMBOL = "Bz";

	public static final String BUCKETHEAD_NAME = "BucketHead Zombie";
	
	public static final String SPORTY_SYMBOL = "Sz";

	public static final String SPORTY_NAME = "Sporty Zombie";
	...
	public static final String PEASHOOTER_SHORTCUT = "p";
	...
	public static final String SUNFLOWER_SHORTCUT = "s";

	public static final String SUNFLOWER_NAME = "Sunflower";
	
	public static final String CHERRYBOMB_NAME_SHORTCUT = "[C]herry-Bomb";

	public static final String CHERRYBOMB_SYMBOL_1 = "c";
	
	public static final String CHERRYBOMB_SYMBOL_2 = "C";
	
	public static final String CHERRYBOMB_SHORTCUT = "c";

	public static final String CHERRYBOMB_NAME = "cherry-bomb";
	
	public static final String WALLNUT_NAME_SHORTCUT = "[W]all-[N]ut";

	public static final String WALLNUT_SYMBOL = "WN";
	
	public static final String WALLNUT_SHORTCUT = "wn";

	public static final String WALLNUT_NAME = "wall-nut";
